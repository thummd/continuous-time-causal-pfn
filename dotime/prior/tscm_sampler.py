...
class TSCMStructure(Enum):
    ...
    - Trivially identified: BIVARIATE
    ...
    BIVARIATE = "bivariate"                            # A -> Y (trivially identified)

    @classmethod
    def _missing_(cls, value):
        # Backwards compatibility: BIVARIATE was called RCT_NO_CONFOUNDING
        # in older configs and checkpoints.
        if value == "rct_no_confounding":
            return cls.BIVARIATE
        return None
...
class TSCMSampler:
    ...
    def _build_bivariate(self) -> TemporalDAG:
